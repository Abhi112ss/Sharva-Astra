...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rollback", "List or restore filesystem checkpoints", "Session",
               args_hint="[number]"),
    CommandDef("snapshot", "Create or restore state snapshots of Sharva-Astra config/state", "Session",
    ...
    CommandDef("steer", "Inject a message after the next tool call without interrupting", "Session",
               args_hint="<prompt>"),
    CommandDef("goal", "Set a standing goal Sharva-Astra works on across turns until achieved", "Session",
    ...
    CommandDef("reload-mcp", "Reload MCP servers from config", "Tools & Skills",
               aliases=("reload_mcp",)),
    CommandDef("reload-skills", "Re-scan the skills folder for newly installed or removed skills",
    ...
    CommandDef("update", "Update Sharva-Astra to the latest version", "Info"),
    CommandDef("version", "Show Sharva-Astra version", "Info", aliases=("v",)),
