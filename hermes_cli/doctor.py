...
Diagnoses issues with Sharva-Astra setup.
"""
...
def run_doctor(args):
    ...
    print(color("│              🩺 Sharva-Astra Doctor                     │", Colors.CYAN))
    print(color("└─────────────────────────────────────────────────────────┘", Colors.CYAN))
    ...
    if soul_path.exists():
        ...
        check_warn(f"{_DHH}/SOUL.md not found", "(create it to give Sharva-Astra a custom personality)")
        if should_fix:
            soul_path.parent.mkdir(parents=True, exist_ok=True)
            soul_path.write_text(
                "# Hermes Agent Persona\n\n"
                "<!-- Edit this file to customize how Hermes communicates. -->\n\n"
                "You are Sharva-Astra, a helpful AI assistant.\n",
                encoding="utf-8",
            )
